...
<div class="contador form large-9 medium-8 columns content">
    ...
    <fieldset>
        ...
        <?php
            ...
            echo $this->Form->control('horas_estudiante', ['pattern'=>"[0-9]", 'label'=>['text'=>'Horas Estudiante'], 'templates'=> ['inputContainer'=>'<div class="row col-xs-10 col-sm-10 col-md-10 col-lg-10">{{content}}</div><br>']]);
        ?>
        </div>
    </fieldset>
    <br>
