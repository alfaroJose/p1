...
<div class="usuarios form large-9 medium-8 columns content">
    ...
    <fieldset>
        ...
        <?php        
            ...
            echo $this->Form->control('nombre_usuario', ['value' => $username, 'readonly', 'required'=>true, 'type' => 'text', 'pattern'=>".{6,50}", 'placeholder'=>'nombre.apellido', 'label'=>['text'=>'Usuario'], 'templates'=> ['inputContainer'=>'<div class="row col-xs-10 col-sm-10 col-md-10 col-lg-10">{{content}}</div><br>']]); 
