...
<div class="grupos form large-9 medium-8 columns content">
    ...
    <fieldset>
        ...
        <?php
            echo $this->Form->control('cursos_id', ['templates'=> ['inputContainer'=>'<div class="row col-xs-10 col-sm-10 col-md-10 col-lg-10">{{content}}</div><br>'],'label' => ['text' => 'Sigla'],'type' => 'text','readonly' ]);
